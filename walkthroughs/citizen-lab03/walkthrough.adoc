...
image::images/05-choose-weebhook.png[05-choose-weebhook.png, role="integr8ly-img-responsive"]

. Click on `Incoming Webhook`

image::images/06-incoming-webhook.png[06-incoming-webhook.png, role="integr8ly-img-responsive"]

. It navigates to the `Webhook Token` screen. Click *Next*

image::images/07-webhook-configuration.png[07-webhook-configuration.png, role="integr8ly-img-responsive"]
...
image::images/08-data-type.png[08-data-type.png, role="integr8ly-img-responsive"]

. Click on `LocationDB` from the catalog and then select `Invoke SQL`

image::images/09-invoke-sql.png[09-invoke-sql.png, role="integr8ly-img-responsive"]
...
image::images/10-invoke-sql-2.png[10-invoke-sql-2.png, role="integr8ly-img-responsive"]

. Click on `Add step` and select `Data mapper`

image::images/11-data-mapper.png[11-data-mapper.png, role="integr8ly-img-responsive"]
...
image::images/12-configure-mapper.png[12-configure-mapper.png, role="integr8ly-img-responsive"]

. Click *Publish* on the next screen and add `Integration Name: addLocation`. Again Click *Publish*.

image::images/13-publish-integration.png[13-publish-integration.png, role="integr8ly-img-responsive"]
