...
image::images/00-integr8ly-che.png[00-integr8ly-che.png, 1024]

Enter dummy values for `First Name` and `Last Name`. Click *Submit*.

image::images/00-integr8ly-che-update-acc.png[00-integr8ly-che-update-acc.png, 1024]
...
+
image::images/00-create-workspace.png[00-create-workspace.png, 1024]
...
+
image::images/00-new-workspace.png[00-new-workspace.png, 1024]

. Click on *Open* to generate and open the workspace.
+
image::images/00-open-workspace.png[00-open-workspace.png, 1024]
...
+
image::images/00-create-ocp-project.png[00-create-ocp-project.png, 1024]
...
+
image::images/00-select-postgres.png[00-select-postgres.png, 1024]
...
+
image::images/00-postgres-credentials.png[00-postgres-credentials.png, 1024]
...
+
image::images/00-import-project.png[00-import-project.png, 1024]
...
+
image::images/00-close-save.png[00-close-save.png, 1024]

. Open the newly created folder, and right-click on the *location-soap2rest* project and select *Convert to Project*
+
image::images/00-convert-project.png[00-convert-project.png, 1024]

. Select *Maven* then click *Save*.
+
image::images/00-select-maven.png[00-select-maven.png, 1024]
...
+
image::images/00-create-spec.png[00-create-spec.png, 1024]

. Right-click on your newly created spec folder and select New > File.  Name the file `location.yaml`.
+
image::images/00-location-yaml.png[00-location-yaml.png, 1024]
...
----
+
image::images/00-terminal.png[00-terminal.png, 1024]
...
+
image::images/00-select-mvn.png[00-select-mvn.png, 1024]
...
+
image::images/00-run-mvn.png[00-run-mvn.png, 1024]
...
+
image::images/00-camel-routes.png[00-camel-routes.png, 1024]
+
[source,java]
----
 package com.redhat;
...
+
image::images/00-update-properties.png[00-update-properties.png, 1024]
...
+
image::images/00-run-locally.png[00-run-locally.png, 1024]
...
+
image::images/00-open-servers.png[00-open-servers.png, 1024]
...
+
image::images/00-location-list.png[00-location-list.png, 1024]
...
+
image::images/00-login-ocp-cli.png[00-location-list.png, 1024]
...
+
image::images/00-login-terminal.png[00-location-list.png, 1024]
...
+
image::images/00-mvn-deploy.png[00-mvn-deploy.png, 1024]
...
+
image::images/00-verify-location-service.png[00-verify-location-service.png, 1024]
