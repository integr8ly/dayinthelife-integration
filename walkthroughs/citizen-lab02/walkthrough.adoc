...
+
image::images/mock-09.png[mock-openshift-login, 1024]
...
. Click on *Upload*.
+
image::images/mock-13.png[mock-jobs, 1024]
+
...
|===
+
image::images/mock-14.png[mock-jobs, 1024]

. Click on the link for your username. eg: *Locations-User1*.
+
image::images/mock-15.png[mock-jobs, 1024]

. Click on the arrow to expand the *Operation GET /locations*.
+
image::images/mock-16.png[mock-mock-service, 1024]
...
+
image::images/mock-17.png[mock-mock-operation, 1024]
...
+
image::images/mock-18.png[mock-curl-service, 1024]
...
+
image::images/mock-19.png[mock-curl-response, 1024]
