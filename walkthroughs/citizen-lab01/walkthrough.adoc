...
+
image::images/design-32.png[design-add-response, role="integr8ly-img-responsive"]

. Click the orange *POST* button to edit the operation.
+
image::images/design-33.png[design-add-response-code, role="integr8ly-img-responsive"]

. Click the *Add a response* link.
+
image::images/design-34.png[design-add-response-code, role="integr8ly-img-responsive"]

. Set the *Response Status Code* value to `201`.  Click Add.
+
image::images/design-35.png[design-add-response-code, role="integr8ly-img-responsive"]
...
+
image::images/design-55.png[design-response-example, role="integr8ly-img-responsive"]
...
+
image::images/design-60.png[design-edit-response, role="integr8ly-img-responsive"]
...
+
image::images/design-36.png[design-location-type, role="integr8ly-img-responsive"]
