...
+
image::images/deploy-10.png[01-scroll-down, 1024]
...
+
image::images/deploy-11.png[02-client-id, 1024]
...
+
image::images/deploy-12.png[03-start-build, 1024]

. A new build will be triggered. Expand the row by clicking the Builds Icon.
+
image::images/deploy-13.png[04-view-build, 1024]
...
+
image::images/consume-22.png[22-updated-app, 1024]
...
+
image::images/consume-24.png[24-client-application, 1024]
...
_Remember to replace the X with your user number._
+
image::images/consume-25.png[25-client-config, 1024]
...
+
image::images/consume-13.png[10-application-page, 1024]

. You can notice now the *Sign In* button in the page.
+
image::images/consume-222.png[11-Sign-in, 1024]
...
+
image::images/consume-23.png[23-realm-login, 1024]
...
+
image::images/consume-14.png[11-locations-page, 1024]
...
+
image::images/00-missing-locations.png[00-missing-locations, 1024]
...
+
image::images/00-developer-console.png[00-developer-console, 1024]
