...
+
image::images/00-open-terminal.png[00-open-terminal.png, 1024]

. In Openshift console (https://dil.opentry.me).
+
image::images/00-openshift-loginpage.png[00-openshift-loginpage.png, 1024]

. Obtain your user login command by clicking on your username on the top right hand corner and select *Copy Login Command*
+
image::images/00-commend-login.png[00-commend-login.png, 1024]
...
+
image::images/00-verify-location-soap.png[00-verify-location-soap.png, 1024]
...
+
image::images/00-verify-wsdl.png[00-verify-wsdl.png, 1024]
...
+
image::images/00-uncomment-codegen.png[00-uncomment-codegen.png, 1024]
...
+
image::images/00-generate-sources.png[00-generate-sources.png, 1024]
...
+
image::images/00-verify-pojos.png[00-verify-pojos.png, 1024]
...
+
image::images/00-local-testing.png[00-local-testing.png, 1024]
...
+
image::images/00-select-servers.png[00-select-servers.png, 1024]

. In the new tab, append the URL with the following URI: `/location/contact/2`.  A contact should be returned:
+
image::images/00-hit-contact-local.png[00-hit-contact-local.png, 1024]
...
+
image::images/00-mvn-f8-deploy.png[00-mvn-f8-deploy.png, 1024]
...
+
image::images/00-verify-pod.png[00-verify-pod.png, 1024]
